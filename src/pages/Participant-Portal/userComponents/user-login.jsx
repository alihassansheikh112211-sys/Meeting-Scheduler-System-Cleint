        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center px-4">
            <div className="bg-gray-800/60 backdrop-blur-xl border border-gray-700 rounded-2xl shadow-2xl p-10 w-full max-w-md">
                ...
                <p className="text-gray-400 mt-3 text-center ">
                    <Link to="/user-forget" className="text-indigo-400 hover:text-indigo-300 font-semibold">
                        Forget Password
                    </Link>
                </p>
                <p className="text-gray-400 text-center mt2">
                    Don’t have an account?{" "}
                    <Link to="/user-register" className="text-indigo-400 hover:text-indigo-300 font-semibold">
                        Sign Up Here
                    </Link>
                </p>
            </div>
