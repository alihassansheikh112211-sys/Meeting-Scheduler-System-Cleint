...
function Aside() {
    ...
    return (
        <div>
            ...
            <div className="min-h-screen  flex-col md:flex-row bg-gradient-to-br from-gray-900 fixed top-0 via-black w-[23%] to-gray-900 flex">
                ...
                <aside className="w-76 bg-gray-950  h-/[100vh] border-r border-gray-800 flex flex-col items-center py-10 gap-2">
                    ...
                    <ul className="flex-1 mt-5 w-full space-y-7">
